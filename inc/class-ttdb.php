<?php
/**
 * Defines ttdb class and related functions
 *
 * @author Matt Beall <mbeall@starverte.com>
 */
...
class ttdb {
   ...
   */
  function connect( $dbname = DB_NAME, $dbuser = DB_USER, $dbpassword = DB_PASSWORD, $dbhost = DB_HOST ) {
    ...
    $conn = new PDO(
      'mysql:unix_socket=/var/mysql/mysql.sock;dbname=' . $dbname . ';host=' . $dbhost,
      $dbuser,
      $dbpassword,
      array(
        PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION,
        PDO::MYSQL_ATTR_SSL_KEY => MYSQL_CLIENT_SSL_KEY,
        PDO::MYSQL_ATTR_SSL_CERT => MYSQL_CLIENT_SSL_CERT,
        PDO::MYSQL_ATTR_SSL_CA => MYSQL_CLIENT_SSL_CA
      )
    );
